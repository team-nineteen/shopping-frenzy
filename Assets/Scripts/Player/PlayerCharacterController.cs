...
public class PlayerCharacterController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            // TODO: Out of bounds. Possibly teleport the player back into the map
        }
    ...
    void HandleCharacterMovement()
    {
        // horizontal character rotation
        {
            ...
            transform.Rotate(new Vector3(0f, (m_InputHandler.GetLookInputsHorizontal() * rotationSpeed * -1f), 0f), Space.Self);
        }
